...
r_known = [
    # 1e3,        # A=1k (B bypassed)
    10e3       # A=10k (B bypassed)
    # 48e3,       # A=1k + B=47k
    # 57e3,       # A=10k + B=47k
    # 100e3,      # A=100k (B bypassed)
    # 147e3,      # A=100k + B=47k
    # 201e3,      # A=1k + B=200k
    # 210e3,      # A=10k + B=200k
    # 300e3,      # A=100k + B=200k
...
r_select_lines = [
    # (0, 0, 0, 0, 1),   # 1k (A=1k, B bypassed)
    (1, 0, 0, 0, 1)   # 10k (A=10k, B bypassed)
    # (0, 0, 0, 0, 0),   # 48k (A=1k + B=47k)
    # (1, 0, 0, 0, 0),   # 57k (A=10k + B=47k)
    # (0, 1, 0, 0, 1),   # 100k (A=100k, B bypassed)
    # (0, 1, 0, 0, 0),   # 147k (A=100k + B=47k)
    # (0, 0, 1, 0, 0),       # 201k (A=1k + B=200k)
    # (1, 0, 1, 0, 0),   # 210k (A=10k + B=200k)
    # (0, 1, 1, 0, 0),   # 300k (A=100k + B=200k)
    # (0, 0, 0, 1, 0),   # 301k (A=1k + B=300k)
    # (1, 0, 0, 1, 0),   # 310k (A=10k + B=300k)
    # (0, 1, 0, 1, 0),   # 400k (A=100k + B=300k)
    # (0, 0, 1, 1, 0),   # 431k (A=1k + B=430k)
    # (1, 0, 1, 1, 0),   # 440k (A=10k + B=430k)
    # (1, 1, 0, 0, 1)    # 510k (A=510k, B bypassed)
    # (0, 1, 1, 1, 0),   # 530k (A=100k + B=430k)
    # (1, 1, 0, 0, 0),   # 557k (A=510k + B=47k)
    # (1, 1, 1, 0, 0),   # 710k (A=510k + B=200k)
    # (1, 1, 0, 1, 0),   # 810k (A=510k + B=300k)
    # (1, 1, 1, 1, 0)    # 940k (A=510k + B=430k)
]

r_labels = [
    "1k   | (A=1k, B bypassed)",
    "10k  | (A=10k, B bypassed)",
    "48k  | (A=1k + B=47k)",
    "57k  | (A=10k + B=47k)",
    "100k | (A=100k, B bypassed)",
    "147k | (A=100k + B=47k)",
    "201k | (A=1k + B=200k)",
    "210k | (A=10k + B=200k)",
    "300k | (A=100k + B=200k)",
...
def sweep(gain_factor_matrix, freq_array):
    temp = read_temp()
    if temp is not None:
